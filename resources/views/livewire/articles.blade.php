    ...
    <div class="flex justify-between">
        ...
        <div class="mr-12 ">
            <button @click='isOpen = true'
                class="px-4 py-2 text-center text-white bg-green-500 rounded hover:bg-green-600">Create</button>
        </div>
    </div>
